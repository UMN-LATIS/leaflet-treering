...
function LTreering (viewer, basePath, options, base_layer, gl_layer) {
  ...
  */
  ...
  this.createTools = new ButtonBar(this, [this.createPoint.btn, this.autoRingDetectionInterface.autoRingDetection.btn, this.mouseLine.btn, this.zeroGrowth.btn, this.createBreak.btn], 'straighten', 'Create new measurements');
  ...
  this.tools = [this.calibration, this.dating, this.createPoint, this.autoRingDetectionInterface.autoRingDetection, this.createBreak, this.universalDelete, this.cut, this.insertPoint, this.convertToStartPoint, this.insertZeroGrowth, this.insertBreak, this.annotationAsset, this.imageAdjustmentInterface.imageAdjustment, this.measurementOptions];
  // --- //
